...
((o.prototype = {
  ...
  (e.prototype = {
    ...
    make: function () {
      if (this.typeNumber < 1) {
        ...
        for (o = 1; o < 40; o++) {
          for (
            var e = v.getRSBlocks(o, this.errorCorrectLevel),
              r = new p(),
              t = 0,
              i = 0;
            i < e.length;
    ...
    setupPositionAdjustPattern: function () {
      for (
        var o = h.getPatternPosition(this.typeNumber), e = 0;
        e < o.length;
        e++
      )
  ...
  (e.createData = function (o, r, t) {
    for (var i = v.getRSBlocks(o, r), n = new p(), a = 0; a < t.length; a++) {
      var d = t[a];
      (n.put(d.mode, 4),
        n.put(d.getLength(), h.getLengthInBits(d.mode, o)),
        d.write(n));
    }
    var u = 0;
...
((f.prototype = {
  ...
  mod: function (o) {
    ...
    for (
      var e = c.glog(this.get(0)) - c.glog(o.get(0)),
  ...
  (v.getRSBlocks = function (o, e) {
    ...
    if (null == r)
      throw new Error(
        "bad rs block @ typeNumber:" + o + "/errorCorrectLevel:" + e,
      );
    for (var t = r.length / 3, i = new Array(), n = 0; n < t; n++)
      for (
        var a = r[3 * n + 0], d = r[3 * n + 1], u = r[3 * n + 2], s = 0;
        s < a;
        s++
      )
        i.push(new v(d, u));
        ...
        this,
        {
          ...
          positionAdjustForegroundColor:
            ...
            (null === (U = o.positionAdjust) || void 0 === U
              ? void 0
              : U.foregroundColor) ||
            (null === ($ = o.alignment) || void 0 === $
              ? void 0
              : $.foregroundColor),
          timingBackgroundColor:
            o.timingBackgroundColor ||
            (null === (J = o.timing) || void 0 === J
              ? void 0
              : J.backgroundColor),
          timingForegroundColor:
            o.timingForegroundColor ||
            (null === (q = o.timing) || void 0 === q
              ? void 0
              : q.foregroundColor),
          typeNumberBackgroundColor:
  ...
  (b.prototype.make = function () {
    ...
    (s.addData(
      ...
      (this.dynamicSize = u
        ? Math.ceil((a - 2 * d) / s.moduleCount) * s.moduleCount + 2 * d
        : a),
      (function (o) {
        let {
            dynamicSize: e,
