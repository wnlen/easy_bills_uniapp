<template>
  ...
  >
    <view
      ...
      style="height: 100%; width: 100%; margin-top: 100px"
    >
      <u-image
        class=""
        :showLoading="true"
      ...
      >
        ...
        >
          ...
          <u-text
            class="iconPeople flex-col justify-center items-center mt10"
            v-if="ite.priceDiscount"
          >
            低至{{ (ite.priceDiscount / 365).toFixed(2) }}元/天</u-text
          >
        </view>
      </view>
      <view
        class="absolute btn flex-col justify-center items-center"
        style="bottom: 40px"
      >
        <view class="ts mb10 mt10"> 新用户半年内免费使用，购买后继续开单 </view>
        <view
          @click="buyRenew"
          class="flex-row justify-center items-center buttonRenew"
        >
