    ...
    <up-overlay :show="show" @click="show = false">
      <view class="letter" @tap.stop>
        ...
        >
          <u-icon
            name="close-circle"
            style="position: absolute; z-index: 11; right: 0; top: -30px"
            color="#ffffff"
            size="50"
            @click="show = false"
          ></u-icon>
...
export default {
  ...
  data() {
    return {
      ...
      timer: null,
      img: [
        "https://res-oss.elist.com.cn/wxImg/letter/pop-letter-a.png",
        "https://res-oss.elist.com.cn/wxImg/letter/pop-letter-b.png",
      ],
    };
  },
  methods: {
