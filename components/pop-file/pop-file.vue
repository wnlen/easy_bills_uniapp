...
<script>
	export default {
		...
		data() {
			return {
				fileIcon: [
					"/wxImg/icon/file/pdf.svg",
					"/wxImg/icon/file/word.svg",
					"/wxImg/icon/file/excel.svg",
					"/wxImg/icon/file/img.svg"
				]
			};
		},
		methods: {
