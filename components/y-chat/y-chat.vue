		...
		>
			<view
				...
				:class="[
					...
					{
						'y-wrap_message_content_my': item[defaultOptions['userId']] == userId
					}
				]"
			>
				...
				<view>
					...
					<view
						:class="[
							...
							{
								'y-wrap_message_content_box_my': item[defaultOptions['userId']] == userId
							}
						]"
					>
						<view
							...
							:class="[
								...
								{
									'y-wrap_message_content_box_msg__me': item[defaultOptions['userId']] == userId
								}
							]"
						>
							<u-tag
