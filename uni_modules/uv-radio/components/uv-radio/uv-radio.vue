<template>
    ...
    >
        <view class="uv-radio__icon-wrap" @tap.stop="iconClickHandler" :class="iconClasses" :style="[iconWrapStyle]">
            <slot name="icon">
                <uv-icon class="uv-radio__icon-wrap__icon" name="checkbox-mark" :size="elIconSize" :color="elIconColor" />
            </slot>
        </view>
        <view class="uv-radio__label-wrap" @tap.stop="labelClickHandler">
            <slot>
                <text
                    :style="{
