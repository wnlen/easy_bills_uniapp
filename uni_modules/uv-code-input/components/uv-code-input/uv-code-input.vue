<template>
    <view class="uv-code-input">
        <view class="uv-code-input__item" :style="[itemStyle(index)]" v-for="(item, index) in codeLength" :key="index">
            <view class="uv-code-input__item__dot" v-if="dot && codeArray.length > index"></view>
            <text
                v-else
                :style="{
            ...
            <view class="uv-code-input__item__line" v-if="mode === 'line'" :style="[lineStyle]"></view>
            <!-- #ifndef APP-PLUS -->
