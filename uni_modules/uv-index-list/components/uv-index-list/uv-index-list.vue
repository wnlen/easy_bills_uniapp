  ...
  <view class="uv-index-list">
    ...
    >
      <view class="uv-index-list__indicator__box">
        ...
        >
          <text class="uv-index-list__indicator__text">{{
  ...
  methods: {
    init() {
      ...
      this.scrollViewHeight =
        this.sys.windowHeight - this.$uv.getPx(this.customNavHeight);
    },
    // 索引列表被触摸
    touchStart(e) {
      // 获取触摸点信息
    ...
    async scrollHandler(e) {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (
          scrollTop + customNavHeight <= children[0].top ||
          ...
          scrollTop + customNavHeight > item.top &&
          scrollTop + customNavHeight < nextItem.top
        ) {
          this.activeIndex = i;
          break;
        }
