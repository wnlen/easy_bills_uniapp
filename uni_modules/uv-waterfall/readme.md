...
该组件主要用于瀑布流式布局显示，视觉表现为参差不齐的多栏布局，随着页面滚动条向下滚动，这种布局还会不断加载数据块并附加至当前尾部，同时集成`nvue`的原生瀑布流用于`app-nvue`。常用于一些电商商品展示等，如某宝首页、x 红书等。

研究 uniapp 瀑布流多年，**该方式是目前小程序端最佳方案**，灵活配置，简单易用，开箱即用。
