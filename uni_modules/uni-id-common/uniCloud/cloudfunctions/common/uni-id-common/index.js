...
function a(e) {
    return 'object' === ((i = e), Object.prototype.toString.call(i).slice(8, -1).toLowerCase()) && e.errCode && ((t = e.errCode), Object.values(n).includes(t)) && !!e.errCode;
    var t, i;
}
let u = {
    'zh-Hans': {
...
class E {
    ...
    checkConfig() {
        ...
        t > e / 2 && console.warn(`Please check whether the tokenExpiresThreshold configuration is set too large, tokenExpiresThreshold: ${t}, tokenExpiresIn: ${e}`);
    }
    get customToken() {
    ...
    async getUserRecord() {
        ...
        if (this.oldTokenPayload) {
            ...
            if (this.userRecord.valid_token_date && this.userRecord.valid_token_date > 1e3 * this.oldTokenPayload.iat) throw { errCode: n.TOKEN_EXPIRED };
        }
...
class x {
    ...
    _getPlatformConfig() {
        ...
        if (!e) throw new Error(`Config for current app (${this._clientInfo.appId}) was not found, please check your config file or client appId`);
        let t;
        switch (
            (['app-plus', 'app-android', 'app-ios'].indexOf(this._clientInfo.platform) > -1 && (this._clientInfo.platform = 'app'),
