...
export default {
  ...
  methods: {
    ...
    _nOnPullingdown(e) {
      if (
        this.refresherStatus === Enum.Refresher.Loading ||
        (this.isIos && !this.nListIsDragging)
      )
        return;
      ...
      if (pullingDistance >= viewHeight) {
        ...
        this.refresherStatus =
          this.refresherF2Enabled &&
          pullingDistance - viewHeight + this.finalRefresherThreshold >=
            this.finalRefresherF2Threshold
            ? Enum.Refresher.GoF2
