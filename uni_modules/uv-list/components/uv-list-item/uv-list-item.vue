    ...
    <cell :keep-scroll-position="keepScrollPosition">
        ...
        <view
            ...
            :style="[
                ...
                {
                    'background-color': customStyle.backgroundColor ? customStyle.backgroundColor : '#fff'
                }
            ]"
                ...
                <slot>
                    <view
                        ...
                        :class="{
                            ...
                            'flex--direction': directionData === 'column'
                        }"
                        :style="{
                    ...
                    >
                        ...
                        <slot name="body">
                            <view
                                ...
                                :class="{
                                    'uv-list-item__content--center': thumb || showExtraIcon || showBadge || showSwitch
                                }"
                            >
                                <text v-if="title" class="uv-list-item__content-title" :class="[ellipsis && `uv-line-${ellipsis}`]">{{ title }}</text>
                                <text v-if="note" class="uv-list-item__content-note">{{ note }}</text>
                            </view>
                        </slot>
                        <slot name="footer">
                            <view v-if="rightText || showBadge || showSwitch" class="uv-list-item__extra" :class="{ 'flex--justify': directionData === 'column' }">
