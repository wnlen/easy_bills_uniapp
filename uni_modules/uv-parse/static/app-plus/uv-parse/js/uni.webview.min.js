!(function (e, n) {
    typeof exports === 'object' && typeof module !== 'undefined' ? (module.exports = n()) : typeof define === 'function' && define.amd ? define(n) : ((e = e || self).uni = n());
})(this, () => {
    'use strict';
    ...
    const a = function (e, n) {
        const t = { options: { timestamp: +new Date() }, name: e, arg: n };
    ...
    const r = /uni-app/i.test(navigator.userAgent);
    const d = /Html5Plus/i.test(navigator.userAgent);
    const s = /complete|loaded|interactive/;
        ...
        var l,
            ...
            f = [
                ...
                function (e) {
                    if (v)
                        return (
                            window.WeixinJSBridge && window.WeixinJSBridge.invoke ? setTimeout(e, 0) : document.addEventListener('WeixinJSBridgeReady', e), window.wx.miniProgram
                        );
                },
                function (e) {
    ...
    l || (l = {});
    const E = typeof uni !== 'undefined' ? uni : {};
    if (!E.navigateTo) for (const b in l) t(l, b) && (E[b] = l[b]);
