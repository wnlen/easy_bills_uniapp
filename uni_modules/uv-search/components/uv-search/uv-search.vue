        ...
        >
            ...
            <slot name="prefix">
                <view class="uv-search__content__icon">
                    <uv-icon @tap="clickIcon" :size="searchIconSize" :name="searchIcon" :color="searchIconColor ? searchIconColor : color"></uv-icon>
                </view>
            </slot>
            <input
                confirm-type="search"
            ...
            />
            <view class="uv-search__content__icon uv-search__content__close" v-if="keyword && clearabled && focused" @tap="clear">
                <uv-icon name="close" size="11" color="#ffffff" customStyle="line-height: 12px"></uv-icon>
            </view>
            <slot name="suffix"></slot>
        </view>
        <text :style="[actionStyle]" class="uv-search__action" :class="[(showActionBtn || show) && 'uv-search__action--active']" @tap.stop.prevent="custom">{{ actionText }}</text>
    </view>
</template>
