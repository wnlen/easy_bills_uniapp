            ...
            for (var o = h.getPatternPosition(this.typeNumber), e = 0; e < o.length; e++)
                for (var r = 0; r < o.length; r++) {
                    ...
                    if (null == this.modules[t][i])
                        for (var n = -2; n <= 2; n++) for (var a = -2; a <= 2; a++) this.modules[t + n][i + a] = -2 == n || 2 == n || -2 == a || 2 == a || (0 == n && 0 == a);
                }
        },
                ...
                for (var e = o.getModuleCount(), r = 0, t = 0; t < e; t++)
                    for (var i = 0; i < e; i++) {
                        for (var n = 0, a = o.isDark(t, i), d = -1; d <= 1; d++)
                            if (!(t + d < 0 || e <= t + d)) for (var u = -1; u <= 1; u++) i + u < 0 || e <= i + u || (0 == d && 0 == u) || (a == o.isDark(t + d, i + u) && n++);
                        n > 5 && (r += 3 + n - 5);
                    }
                for (t = 0; t < e - 1; t++)
                    for (i = 0; i < e - 1; i++) {
...
(f.prototype = {
    ...
    (v.getRSBlocks = function (o, e) {
        ...
        for (var t = r.length / 3, i = new Array(), n = 0; n < t; n++) for (var a = r[3 * n + 0], d = r[3 * n + 1], u = r[3 * n + 2], s = 0; s < a; s++) i.push(new v(d, u));
        return i;
    }),
            ...
            (function (o = {}, e = {}, r = !1) {
                ...
                this,
                {
                    ...
                    backgroundImageBorderRadius:
                        o.backgroundImageBorderRadius || (null === (m = o.background) || void 0 === m || null === (f = m.image) || void 0 === f ? void 0 : f.borderRadius),
                    ...
                    foregroundImagePadding:
                        o.foregroundImagePadding || (null === (L = o.foreground) || void 0 === L || null === (D = L.image) || void 0 === D ? void 0 : D.padding),
                    foregroundImageBackgroundColor:
                        o.foregroundImageBackgroundColor || (null === (A = o.foreground) || void 0 === A || null === (E = A.image) || void 0 === E ? void 0 : E.backgroundColor),
                    foregroundImageBorderRadius:
                        o.foregroundImageBorderRadius || (null === (T = o.foreground) || void 0 === T || null === (N = T.image) || void 0 === N ? void 0 : N.borderRadius),
                    foregroundImageShadowOffsetX:
                        o.foregroundImageShadowOffsetX || (null === (M = o.foreground) || void 0 === M || null === (z = M.image) || void 0 === z ? void 0 : z.shadowOffsetX),
                    foregroundImageShadowOffsetY:
                        o.foregroundImageShadowOffsetY || (null === (R = o.foreground) || void 0 === R || null === (_ = R.image) || void 0 === _ ? void 0 : _.shadowOffsetY),
                    foregroundImageShadowBlur:
                        o.foregroundImageShadowBlur || (null === (O = o.foreground) || void 0 === O || null === (F = O.image) || void 0 === F ? void 0 : F.shadowBlur),
                    foregroundImageShadowColor:
                        o.foregroundImageShadowColor || (null === (x = o.foreground) || void 0 === x || null === (H = x.image) || void 0 === H ? void 0 : H.shadowColor),
    ...
    (b.prototype.make = function () {
        let { foregroundColor: o, backgroundColor: r, typeNumber: t, errorCorrectLevel: i, data: n, size: a, margin: d, useDynamicSize: u } = this;
        if (o === r)
        ...
        s.addData(
            (function (o) {
                ...
                for (var e, r = '', t = 0; t < o.length; t++)
                    (e = o.charCodeAt(t)) >= 1 && e <= 127
                        ? (r += o.charAt(t))
                        : e > 2047
                        ? ((r += String.fromCharCode(224 | ((e >> 12) & 15))), (r += String.fromCharCode(128 | ((e >> 6) & 63))), (r += String.fromCharCode(128 | ((e >> 0) & 63))))
            ...
            (function (o) {
                let { dynamicSize: e, margin: r, backgroundColor: t, backgroundPadding: i, foregroundColor: n, foregroundPadding: a, modules: d, moduleCount: u } = o,
                    s = (e - 2 * r) / u,
                    g = s,
                    l = 0;
                i > 0 && ((l = (g * i) / 2), (g -= 2 * l));
                            ...
                            (e < 9 && c < 9) ||
                                ...
                                o.forEach((o) => {
                                    ...
                                    t.type.push('positionAdjust'),
                                        t.type.includes('timing') ? (1 == o[2] ? (t.color = a == i ? u : a) : (t.color = a == i && d == n ? s : d)) : (t.color = 1 == o[2] ? a : d);
                                });
                        }
                }
            })(this),
