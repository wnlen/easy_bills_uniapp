  ...
  >
    <view class="uv-action-sheet">
      <view class="uv-action-sheet__header" v-if="title">
        <text class="uv-action-sheet__header__title uv-line-1">{{
          title
        }}</text>
        ...
        <view class="uv-action-sheet__item-wrap">
          <view v-for="(item, index) in actions" :key="index">
            ...
            <button
              ...
              :hover-class="
                !item.disabled && !item.loading ? 'uv-action-sheet--hover' : ''
              "
            >
              <!-- #endif -->
              <view
...
$uv-action-sheet-cancel-text-hover-background-color: rgb(
  242,
  243,
  245
) !default;
