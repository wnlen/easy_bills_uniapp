          ...
          <slot>
            <template v-if="!customabc">
              <text
                ...
                :class="[
                  !abc &&
                    'uv-keyboard__button__inner-wrapper__left__lang--active',
                ]"
                >中</text
              >
              <text class="uv-keyboard__button__inner-wrapper__left__line"
                >/</text
              >
              <text
                class="uv-keyboard__button__inner-wrapper__left__lang"
      ...
      >
        <view
          :class="[
            ...
            {
              'uv-keyboard__button__inner-wrapper__inner--disabled': isDisabled(
                i,
                j,
              ),
            },
        ...
        >
          <text class="uv-keyboard__button__inner-wrapper__inner__text">{{
            item
          }}</text>
        </view>
        <view
