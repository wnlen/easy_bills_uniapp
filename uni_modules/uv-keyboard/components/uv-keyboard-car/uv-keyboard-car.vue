<template>
    <view class="uv-keyboard" @touchmove.stop.prevent="noop">
        <view v-for="(group, i) in abc ? engKeyBoardList : areaList" :key="i" class="uv-keyboard__button" :index="i" :class="[i + 1 === 4 && 'uv-keyboard__button--center']">
            <view v-if="i === 3" class="uv-keyboard__button__inner-wrapper">
                <view class="uv-keyboard__button__inner-wrapper__left" hover-class="uv-hover-class" :hover-stay-time="200" @tap="changeCarInputMode">
                    <slot>
                        <template v-if="!customabc">
                            <text class="uv-keyboard__button__inner-wrapper__left__lang" :class="[!abc && 'uv-keyboard__button__inner-wrapper__left__lang--active']">中</text>
                            <text class="uv-keyboard__button__inner-wrapper__left__line">/</text>
                            <text class="uv-keyboard__button__inner-wrapper__left__lang" :class="[abc && 'uv-keyboard__button__inner-wrapper__left__lang--active']">英</text>
                        </template>
                    </slot>
                </view>
            </view>
            <view class="uv-keyboard__button__inner-wrapper" v-for="(item, j) in group" :key="j">
                <view
                    :class="[
                        'uv-keyboard__button__inner-wrapper__inner',
                        {
                            'uv-keyboard__button__inner-wrapper__inner--disabled': isDisabled(i, j)
                        }
                    ]"
                    :hover-stay-time="200"
            ...
            <view v-if="i === 3" @touchstart="backspaceClick" @touchend="clearTimer" class="uv-keyboard__button__inner-wrapper">
                <view class="uv-keyboard__button__inner-wrapper__right" hover-class="uv-hover-class" :hover-stay-time="200">
                    <uv-icon size="28" name="backspace" color="#303133"></uv-icon>
                </view>
            </view>
        </view>
    </view>
