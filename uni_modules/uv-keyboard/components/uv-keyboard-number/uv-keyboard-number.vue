<template>
    <view class="uv-keyboard" @touchmove.stop.prevent="noop">
        <view class="uv-keyboard__button-wrapper" v-for="(item, index) in numList" :key="index">
            <view class="uv-keyboard__button-wrapper__button" :style="[itemStyle(index)]" @tap="keyboardClick(item)" hover-class="uv-hover-class" :hover-stay-time="200">
                <text class="uv-keyboard__button-wrapper__button__text">{{ item }}</text>
            </view>
        </view>
        <view class="uv-keyboard__button-wrapper">
            <view
                ...
                @touchend="clearTimer"
            >
                <uv-icon name="backspace" color="#303133" size="28"></uv-icon>
            </view>
        </view>
    </view>
</template>
