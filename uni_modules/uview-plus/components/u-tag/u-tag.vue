<template>
    <u-transition mode="fade" :show="show" style="display: inline-flex">
            ...
            >
                ...
                <view class="u-tag__content">
                    ...
                    <template v-if="!$slots.content">
                        ...
                        <text v-else class="u-tag__text" :style="[textColor]" :class="[`u-tag__text--${type}`, plain && `u-tag__text--${type}--plain`, `u-tag__text--${size}`]">
                            <slot></slot>
                        </text>
                    </template>
                </view>
            </view>
            <view class="u-tag__close" :class="[`u-tag__close--${size}`]" v-if="closable" @tap.stop="closeHandler" :style="{ backgroundColor: closeColor }">
