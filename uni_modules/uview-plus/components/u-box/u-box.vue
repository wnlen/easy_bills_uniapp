<template>
  <view class="u-box" :style="[{ height: height }, addStyle(customStyle)]">
    <view
      class="u-box__left"
      :style="{ borderRadius: borderRadius, backgroundColor: bgColors[0] }"
    >
    ...
    <view class="u-box__right">
      <view
        ...
        :style="{ borderRadius: borderRadius, backgroundColor: bgColors[1] }"
      >
      ...
      <view
        ...
        :style="{ borderRadius: borderRadius, backgroundColor: bgColors[2] }"
      >
