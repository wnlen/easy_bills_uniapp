<template>
    <view class="u-picker-data">
        <view class="u-picker-data__trigger">
            ...
            <view @click="show = true" class="u-picker-data__trigger__cover"></view>
        </view>
        <up-picker :show="show" :columns="optionsInner" :keyName="labelKey" :defaultIndex="defaultIndex" @confirm="select" @cancel="cancel"></up-picker>
    </view>
</template>
