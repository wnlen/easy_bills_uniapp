<template>
    <view class="u-datetime-picker">
        <view v-if="hasInput" class="u-datetime-picker__has-input" @click="onShowByClickInput">
            <slot name="trigger" :value="inputValue">
                <up-input :readonly="!!showByClickInput" v-model="inputValue" v-bind="inputPropsInner"></up-input>
