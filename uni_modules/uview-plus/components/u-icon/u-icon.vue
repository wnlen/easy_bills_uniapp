<template>
    <view class="u-icon" @tap="clickHandler" :class="['u-icon--' + labelPos]">
        ...
        <text v-else class="u-icon__icon" :class="uClasses" :style="[iconStyle, addStyle(customStyle)]" :hover-class="hoverClass">{{ icon }}</text>
 ...
 * @example <u-icon name="photo" color="#2979ff" size="28rpx"></u-icon>
 */
export default {
    name: 'u-icon',
    beforeCreate() {
