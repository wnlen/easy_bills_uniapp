<template>
    <view class="u-slider" :style="[addStyle(customStyle)]">
        <template v-if="!useNative || isRange">
            ...
            >
                ...
                <text
                    ...
                    :style="{
                        left: getPx(barStyle0.width) + getPx(blockSize) / 2 + 'px'
                    }"
                >
                    {{ this.rangeValue[0] }}
                </text>
                <text v-if="isRange && showValue" class="u-slider__show-range-value" :style="{ left: getPx(barStyle.width) + getPx(blockSize) / 2 + 'px' }">
                    {{ this.rangeValue[1] }}
                </text>
    ...
    methods: {
        ...
        format(value, index = 1) {
            ...
            if (this.isRange) {
                switch (index) {
                    case 0:
                        return Math.round(Math.max(this.min, Math.min(value, this.rangeValue[1] - parseInt(this.step), this.max)) / parseInt(this.step)) * parseInt(this.step);
                        break;
                    case 1:
                        return Math.round(Math.max(this.min, this.rangeValue[0] + parseInt(this.step), Math.min(value, this.max)) / parseInt(this.step)) * parseInt(this.step);
                        break;
                    default:
                        break;
                }
