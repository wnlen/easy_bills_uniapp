<template>
    <view class="u-cate-tab" :style="{ height: addUnit(height) }">
        <view class="u-cate-tab__wrap">
            <scroll-view class="u-cate-tab__view u-cate-tab__menu-scroll-view" scroll-y scroll-with-animation :scroll-top="scrollTop" :scroll-into-view="itemId">
                <view
            ...
            <scroll-view :scroll-top="scrollRightTop" scroll-with-animation scroll-y class="u-cate-tab__right-box" @scroll="rightScroll">
    ...
    methods: {
        ...
        async observer() {
            this.tabList.map((val, index) => {
                ...
                observer
                    .relativeTo('.u-cate-tab__right-box', {
                        top: 0
                    })
        ...
        getMenuItemTop() {
            return new Promise((resolve) => {
                ...
                selectorQuery
                    .selectAll('.u-cate-tab__page-item')
