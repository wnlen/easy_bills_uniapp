...
declare module "uview-plus" {
  ...
  interface test {
    ...
    /** 判断是否为空 */
    empty(
      value: string | number | undefined | boolean | object | null,
    ): boolean;
    /** 是否json字符串 */
...
declare type UniCountDownRef =
  (typeof import("./comps/countDown"))["CountDownRef"];
declare type UniCountToRef = (typeof import("./comps/countTo"))["CountToRef"];
declare type UniReadMoreRef =
  (typeof import("./comps/readMore"))["ReadMoreRef"];
declare type UniToastRef = (typeof import("./comps/toast"))["ToastRef"];
declare type UniCollapseRef =
  (typeof import("./comps/collapse"))["CollapseRef"];
...
declare type UniDatetimePickerRef =
  (typeof import("./comps/datetimePicker"))["DatetimePickerRef"];
declare type UniPickerRef = (typeof import("./comps/picker"))["PickerRef"];
declare type UniCalendarRef =
  (typeof import("./comps/calendar"))["CalendarRef"];
declare type UniTextareaRef =
  (typeof import("./comps/textarea"))["TextareaRef"];
