<template>
    <uv-popup ref="calendarPopup" mode="bottom" closeable :round="round" :closeOnClickOverlay="closeOnClickOverlay" @change="popupChange">
        <view class="uv-calendar">
            <uvHeader :title="title" :subtitle="subtitle" :showSubtitle="showSubtitle" :showTitle="showTitle"></uvHeader>
            <scroll-view :style="{ height: $uv.addUnit(listHeight) }" scroll-y @scroll="onScroll" :scroll-top="scrollTop" :scrollIntoView="scrollIntoView">
                <uvMonth
                    :color="color"
                    :rowHeight="rowHeight"
                    :showMark="showMark"
            ...
            <slot name="footer" v-if="showConfirm">
                <view class="uv-calendar__confirm">
                    <uv-button shape="circle" :text="buttonDisabled ? confirmDisabledText : confirmText" :color="color" @click="confirm" :disabled="buttonDisabled"></uv-button>
                </view>
            </slot>
        </view>
    </uv-popup>
        ...
        setMonth() {
            ...
            const maxDate =
                ...
                dayjs(minDate)
                    ...
                    .valueOf();
            // 最大最小月份之间的共有多少个月份，
            const months = this.$uv.range(1, this.monthNum, this.getMonths(minDate, maxDate));
            // 先清空数组
            this.months = [];
