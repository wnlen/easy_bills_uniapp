<template>
    <view class="uv-tooltip" :style="[$uv.addStyle(customStyle)]">
        <uv-overlay
        ...
        <view class="uv-tooltip__wrapper">
            ...
            >
                <view class="uv-tooltip__wrapper__popup" :id="tooltipId" :ref="tooltipId">
                    <view
                    ...
                    <view class="uv-tooltip__wrapper__popup__list">
                        <view v-if="showCopy" class="uv-tooltip__wrapper__popup__list__btn" hover-class="uv-tooltip__wrapper__popup__list__btn--hover" @tap="setClipboardData">
                            <text class="uv-tooltip__wrapper__popup__list__btn__text">复制</text>
                        </view>
                        <uv-line direction="column" color="#8d8e90" v-if="showCopy && buttons.length > 0" length="18"></uv-line>
                        <block v-for="(item, index) in buttons" :key="index">
                            <view class="uv-tooltip__wrapper__popup__list__btn" hover-class="uv-tooltip__wrapper__popup__list__btn--hover">
                                <text class="uv-tooltip__wrapper__popup__list__btn__text" @tap="btnClickHandler(index)">{{ item }}</text>
                            </view>
                            <uv-line direction="column" color="#8d8e90" v-if="index < buttons.length - 1" length="18"></uv-line>
                        </block>
                    </view>
                </view>
            </uv-transition>
