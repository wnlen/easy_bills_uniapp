      ...
      >
        ...
        >
          ...
          <view class="uv-tooltip__wrapper__popup__list">
            ...
            >
              <text class="uv-tooltip__wrapper__popup__list__btn__text"
                >复制</text
              >
            </view>
            <uv-line
  ...
  computed: {
    ...
    tooltipStyle() {
      ...
      if (
        ...
        this.indicatorStyle.left = this.$uv.addUnit(
          this.textInfo.width / 2 -
            this.$uv.getPx(style.left) -
            this.indicatorWidth / 2,
        );
      } else if (
        this.tooltipInfo.width / 2 >
        this.$uv.sys().windowWidth -
          this.textInfo.right +
          this.textInfo.width / 2 -
          this.screenGap
      ) {
        ...
        this.indicatorStyle.right = this.$uv.addUnit(
          this.textInfo.width / 2 -
            this.$uv.getPx(style.right) -
            this.indicatorWidth / 2,
        );
      } else {
        const left = Math.abs(
