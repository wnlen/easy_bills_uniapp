...
function drawXAxis(r, h, c, d) {
    ...
    if (h.xAxis.title) {
        ...
        d.fillText(
            ...
            h.height - h.area[2] + h.xAxis.marginTop * h.pix + ((h.xAxis.lineHeight - h.xAxis.titleFontSize) * h.pix) / 2 + (h.xAxis.titleFontSize + h.xAxis.titleOffsetY) * h.pix
        );
        d.closePath();
        d.stroke();
    }
...
function drawPieDataPoints(t, r, e, o) {
    ...
    var i = Math.min(
        (r.width - r.area[1] - r.area[3]) / 2 - e.pieChartLinePadding - e.pieChartTextPadding - e._pieTextMaxLength_,
...
uCharts.prototype.getCurrentDataIndex = function (e) {
    ...
    if (a) {
        ...
        if (this.opts.type === 'pie' || this.opts.type === 'ring') {
            ...
            return findRadarChartCurrentIndex({ x: t.x, y: t.y }, this.opts.chartData.radarData, this.opts.categories.length);
            ...
            return findBarChartCurrentIndex({ x: t.x, y: t.y }, this.opts.chartData.calPoints, this.opts, this.config, Math.abs(this.scrollOption.currentOffset));
        } else {
            return findCurrentIndex({ x: t.x, y: t.y }, this.opts.chartData.calPoints, this.opts, this.config, Math.abs(this.scrollOption.currentOffset));
        }
    }
    return -1;
};
