<template>
	<view class="content bg-gray">
		<view class="user-top flex-col items-center pt20 pl30 pr30 pb30" style="z-index: 1;background-color: #ffffff;"
				...
				<view class="flex-row flex-1 ml24 items-center" style="">
					...
					<view class="flex-col justify-left ml20" style="width: 100%;">
						...
						<view class=" flex-row justify-left items-center" style="" @click="userClick">
							...
							<view class="flex-row justify-between ml20" style="width: 60px;height: 30px;"
								v-if="vuex_user.data">
								<image v-if="vuex_user.data.work!='1'"
									src="https://res-oss.elist.com.cn/wxImg/user/zzh.svg"
									style="width: 100%;height: 100%;">
								</image>
								<view v-if="vuex_user.data.work=='1'" style="width: 100%;height: 100%;">
									<image v-if="vuex_user.workData.identity=='1'"
										src="https://res-oss.elist.com.cn/wxImg/user/hhr.svg"
										style="width: 100%;height: 100%;">
									</image>
									<image v-if="vuex_user.workData.identity=='3'"
										src="https://res-oss.elist.com.cn/wxImg/user/cw.svg"
										style="width: 100%;height: 100%;">
									</image>
									<image v-if="vuex_user.workData.identity=='4'"
...
<!-- 										<text class="pb5"
								...
								<view class="items-center absolute" @click="generateCode" style="right: 5%;top:14%">
									<u-icon size="70" :name="ImgUrl+'/wxImg/user/QRCode.svg'"></u-icon>
								</view>
							</view>
						</view>
					</view>
			...
			<view class="card flex-row bg-white mt25 ml24 mr24 cardShowPlus" style="border-radius: 6px;height: 12vh;">
				<view class="icon" style="" id="box">
					<view class="" @click="menuClick(menusIcon[0])">
						<u-icon size="100" :name="ImgUrl+'/wxImg/user/wddd.png'"></u-icon>
						<view>我的订购</view>
					</view>
				</view>
				<view class="icon" @click="menuClick(menusIcon[1])">
					<view class="">
						<u-icon size="100" :name="ImgUrl+'/wxImg/user/grzl.png'"></u-icon>
						<view>个人资料</view>
					</view>
				</view>
				<view class="icon" @click="menuClick(menusIcon[2])">
					<view class="">
						<u-icon size="100" :name="ImgUrl+'/wxImg/user/rygl.png'"></u-icon>
						<view>人员管理</view>
					</view>
				</view>
				<view class="icon" @click="menuClick(menusIcon[3])">
					<view class="">
						<u-icon size="100" :name="ImgUrl+'/wxImg/user/qsgl.png'"></u-icon>
						<view>签收管理</view>
					</view>
				</view>
			</view>
...
<script>
	export default {
		data() {
			return {
				tabHight: "50px",
				backgroundImage: ["https://res-oss.elist.com.cn/wxImg/index/indexR.png",
