<template>
  <view class="content bg-gray">
    ...
    >
      <view
        class="flex-row items-center flex-1"
        style="width: 100vw; margin-top: 2.5vh"
      >
        <view class="flex-row flex-1 ml24 items-center" style="">
          <view>
            ...
            <u-avatar
              size="60"
              :src="
                vuex_user.data.headPortrait == null
            ...
            <u-avatar
              size="60"
              src="https://res-oss.elist.com.cn/wxImg/index/mr.svg"
              @click="userClick"
            ></u-avatar>
            <!-- #endif -->
          </view>
            ...
            >
              <view class="ml15">
                <view class="ft-color ft42 ft-zjj-1" style="font-weight: 500">
                  {{
                    vuex_user.phone == undefined
                      ? "请登录~"
                      : userName(vuex_user.data.name) || "设置用户名~"
                  }}
                </view>
              </view>
              <view
                class="flex-row justify-between ml20"
                style="width: 120rpx; height: 60rpx"
                v-if="vuex_user.data"
              >
                <image
                  v-if="vuex_user.data.work != '1'"
                  src="https://res-oss.elist.com.cn/wxImg/user/zzh.svg"
                ...
                >
                  ...
                  ></image>
                  <image
                    v-if="vuex_user.workData.identity == '3'"
                    src="https://res-oss.elist.com.cn/wxImg/user/cw.svg"
                    style="width: 100%; height: 100%"
                  ></image>
                  <image
                    v-if="vuex_user.workData.identity == '4'"
            ...
            <view class="flex-col justify-left mt20" style="">
              <view class="ft-zjj-05" @click="userClick">
                <view class="flex-row items-center">
                  <u-icon
                    size="50rpx"
                    :name="ImgUrl + '/wxImg/user/my-phone.png'"
                  ></u-icon>
              ...
              <view class="">
                <view class="ft-zjj-05" @click="userClick">
                  <view class="flex-row items-center">
                    <u-icon
                      size="50rpx"
                      :name="ImgUrl + '/wxImg/user/my-emp.png'"
                    ></u-icon>
                ...
                >
                  <u-icon
                    size="70rpx"
                    :name="ImgUrl + '/wxImg/user/QRCode.svg'"
                  ></u-icon>
                </view>
              </view>
            </view>
    ...
    <view class="user-menu" style="position: relative; z-index: 10">
      <view
        class="card flex-row bg-white mt25 ml24 mr24 cardShowPlus"
        style="border-radius: 6px; height: 12vh"
      >
        <view class="icon" style="" id="box">
          <view class="" @click="menuClick(menusIcon[0])">
            <u-icon
              size="100rpx"
              :name="ImgUrl + '/wxImg/user/wddd.png'"
            ></u-icon>
        ...
        <view class="icon" @click="menuClick(menusIcon[1])">
          <view class="">
            <u-icon
              size="100rpx"
              :name="ImgUrl + '/wxImg/user/grzl.png'"
            ></u-icon>
        ...
        <view class="icon" @click="menuClick(menusIcon[2])">
          <view class="">
            <u-icon
              size="100rpx"
              :name="ImgUrl + '/wxImg/user/rygl.png'"
            ></u-icon>
        ...
        <view class="icon" @click="menuClick(menusIcon[3])">
          <view class="">
            <u-icon
              size="100rpx"
              :name="ImgUrl + '/wxImg/user/qsgl.png'"
            ></u-icon>
      ...
      >
        <view class="" style="width: 94%">
          <u-cell-group :border="false">
            ...
            <u-cell
              :title="menus[menus.length - 1].name"
              isLink
              @click="menuClick(menus[menus.length - 1])"
              :border="false"
            >
              <template #icon>
                <u-icon
                  slot="icon"
                  size="40rpx"
                  :name="ImgUrl + menus[menus.length - 1].icon"
                  color="#999"
                  :custom-style="{ marginRight: '20rpx' }"
                ></u-icon>
              </template>
...
export default {
  data() {
    return {
      tabHight: "50px",
      backgroundImage: [
        "https://res-oss.elist.com.cn/wxImg/index/indexR.png",
        "https://res-oss.elist.com.cn/wxImg/index/indexbg.png",
      ],
      eye: 1,
      price: 0,
      pricb: 0,
        ...
        this.getElementData("#box", (res) => {
          this.setFunctionGuideData({
            ...
            tipsPosition: {
              ...
              left: "0",
              backgroundImage:
                "url(https://res-oss.elist.com.cn/wxImg/handbook/guide/stepD4.png)",
            },
            position: {
              // 自定义导航栏
