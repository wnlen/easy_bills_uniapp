<template>
  <view class="page-container">
    ...
    <view class="top-img">
      <image
        class="banner"
        src="https://res-oss.elist.com.cn/share/banner.png"
        mode="widthFix"
      >
      </image>
    </view>
    <view class="page-list">
      <view class="banner_t">
        <image
          class="banner_text"
          src="https://res-oss.elist.com.cn/share/banner_center.png"
          mode="widthFix"
        >
        </image>
      </view>
      ...
      <view class="page-list-jindu">
        <image
          class="jindu_img"
          src="https://res-oss.elist.com.cn/share/yaoqingjindutiao.png"
          mode="widthFix"
        ></image>
        <view class="jindu_text">
          <uv-line-progress
            height="18"
            :percentage="15 + ((inviteCount * 100) / 15) * 0.85"
            activeColor="#FE962A"
          >
      ...
      <view class="page-list-ddtj">
        <image
          class="ddtj_icon"
          src="https://res-oss.elist.com.cn/share/dingdanicon.png"
          mode="widthFix"
        ></image>
        ...
        <view
          class="ddtj_btn"
          v-else-if="canClaim3Month"
          @click="claimReward('invitation3month')"
          >领取</view
        >
      ...
      <view class="page-list-ddtj">
        ...
        <view
          class="ddtj_btn"
          v-else-if="canClaim12Month"
          @click="claimReward('invitation12month')"
          >领取</view
        >
        <view class="ddtj_btn_disabled" v-else>领取</view>
      </view>
