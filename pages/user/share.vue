<template>
	<view class="page-container">
		...
		<view class="top-img">
			<image class="banner" src="https://res-oss.elist.com.cn/share/banner.png" mode="widthFix">
			</image>
		</view>
		<view class="page-list">
			<view class="banner_t">
				<image class="banner_text" src="https://res-oss.elist.com.cn/share/banner_center.png" mode="widthFix">
				</image>
			</view>
			<view class="list-box">
				...
				<button class="btn_1" open-type="share">
					分享好友
				</button>
				<button class="btn_2" @click="saveQr">
					下载
				</button>
				<view class="box-text">
					注:邀请新好友注册登录累计一个人数
