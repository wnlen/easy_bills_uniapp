  ...
  <view class="root">
    ...
    >
      <view slot="top" style="padding-bottom: 60rpx">
        ...
        <view
          class="absolute"
          style="text-align: left; font-size: 24rpx; color: #01bb74; left: 0"
          :disabled="false"
        >
          ...
          <view class="flex-row items-center vw100">
            ...
            >
              <view class="relative" @click="showCheckClick">
                ...
                <u-icon
                  size="100"
                  name="https://res-oss.elist.com.cn/wxImg/order/checkOrder.svg"
                ></u-icon>
              </view>
              <view
                class="mr20 flex-row"
            ...
            >
              ...
              >
                ...
                <text class="ft30 line25 ft-lighgray">
                  <text
                    >日期：{{
                      $u.timeFormat(item.creationTime, "yyyy-mm-dd")
                    }}</text
                  >
                </text>
            ...
            <view class="flex-row justify-between items-center">
              <view class="flex-row items-center vw100">
                ...
                >
                  ...
                  >
                    统计：
                    <view style="color: #01bb74"
                      >{{ OrderQuantity }}个订单</view
                    >
                  </view>
                  <view
                    :disabled="!hasCheck"
  ...
  methods: {
    ...
    OpenReceipt() {
      ...
      if (this.checked) {
        ...
        console.log("全选");
        //获取单据id
        this.$api.bills.checkAllLockedIds(this.realTimeSel).then((res) => {
          console.log(res);
        ...
        //计算价格
        this.$api.bills
          .getLockedBillTotalPrice(this.realTimeSel)
          .then((res) => {
    ...
    checkboxGroupChange(event, index) {
      ...
      if (this.orderList[index].check) {
        ...
        this.realTimeSel.ids = this.realTimeSel.ids.filter(
          (id) => id != this.orderList[index].id,
        );
        ...
        .then((res) => {
          ...
          var orderList = res.data.data.map((obj) => {
            ...
            return {
              ...
              check: this.checked
                ? true
                : this.ids.includes(obj.id) ||
                  this.realTimeSel.ids.includes(obj.id),
              show: false,
            };
          });
