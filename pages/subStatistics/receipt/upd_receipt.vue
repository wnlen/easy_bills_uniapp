	...
	<view class="root">
		...
		>
			<view slot="top" style="padding-bottom: 60rpx">
				...
				<view class="absolute" style="text-align: left; font-size: 12px; color: #01bb74; left: 0" :disabled="false">
	...
	methods: {
		...
		OpenReceipt() {
			...
			if (this.checked) {
				...
				//计算价格
				this.$api.bills.getLockedBillTotalPrice(this.realTimeSel).then((res) => {
