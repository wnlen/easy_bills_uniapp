    ...
    <view class="FROMBill">
      ...
      <view class="FromOwn">
        ...
        <view
          ...
          v-if="
            (vuex_user.data.work == '0'
              ...
              : billFrom.sourcePhone == vuex_user.workData.bossNumber &&
                vuex_userRole == 'D') ||
            (vuex_user.data.work == '0'
              ? billFrom.receptionPhone == vuex_user.phone &&
                vuex_userRole == 'R'
              : billFrom.receptionPhone == vuex_user.workData.bossNumber &&
                vuex_userRole == 'R')
          "
        >
        ...
        <view class="OwnText">
          ...
          <text class="OwnTextFromText"
            >￥{{ parseFloat(billFrom.billAfterPrice).toFixed(2) }}</text
          >
        </view>
      </view>
