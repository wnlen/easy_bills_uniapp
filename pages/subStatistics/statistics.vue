  ...
  <view class="vh100 vw100 fixed-bar-height bg-gray">
    ...
    >
      <u-sticky>
        <u-navbar :autoBack="true" :placeholder="true">
          <template #center>
            <view
              class="flex-row items-center justify-center ml50"
              style="width: 100%"
            >
              ...
              >
                ...
                <u-icon
                  name="https://res-oss.elist.com.cn/wxImg/video.png"
                  size="20rpx"
                ></u-icon>
              </view>
            </view>
          ...
          <view class="fliter-wrap-view">
            ...
            >
              <u-icon
                v-if="item.key == false"
                size="35rpx"
                name="https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/vip/vip.svg"
              ></u-icon>
              {{ item.value }}
            </view>
          </view>
      ...
      <view class="ml24 mr24 mb24">
        ...
        >
          ...
          >
            ...
            >
              <text class="ft11 ft-gray ml36 mr20" @click="CustomerGet">{{
        ...
        >
          <view class="flex-row items-center vw100">
            ...
            >
              <view
                class=""
                style="text-align: left; font-size: 24rpx; color: #01bb74"
                :disabled="false"
              >
    ...
    <view class="order-simple-list pl30 pr30">
      ...
      <u-popup v-model="show_start" mode="top" width="100%">
        ...
        <view
          class="flex-col pl30 pr30 pb30 justify-between height100"
          style="width: 100%"
        >
...
export default {
  ...
  onLoad() {
    ...
    for (let key in this.vuex_user.jurisdiction) {
      var date = this.$u.timeFormat(
        this.vuex_user.jurisdiction[key],
        "yyyy-mm-dd",
      );
  ...
  onShow() {
    ...
    if (this.date1 == "" && this.date2 == "") {
      ...
      var oneWeekAgo = this.$u.timeFormat(
        new Date(timeNow.getTime() - 7 * 24 * 60 * 60 * 1000),
        "yyyy-mm-dd",
      );
  ...
  methods: {
    ...
    filterSubmit() {
      ...
      this.realTimeSel.endDate =
        this.date2 != ""
          ? this.date2
          : this.$u.timeFormat(new Date(), "yyyy-mm-dd");
      this.$refs.paging.reload();
    },
    filterReset() {
      this.date1 = "";
      this.date2 = "";
      var timeNow = new Date();
      var oneMonthAgo = this.$u.timeFormat(
        new Date(
          timeNow.getFullYear(),
          timeNow.getMonth() - 1,
          timeNow.getDate(),
      ...
      var twoMonthsAgo = this.$u.timeFormat(
        new Date(
          timeNow.getFullYear(),
          timeNow.getMonth() - 2,
          timeNow.getDate(),
      ...
      var threeMonthsAgo = this.$u.timeFormat(
        new Date(
          timeNow.getFullYear(),
          timeNow.getMonth() - 3,
          timeNow.getDate(),
      ...
      var sixMonthsAgo = this.$u.timeFormat(
        new Date(
          timeNow.getFullYear(),
          timeNow.getMonth() - 6,
          timeNow.getDate(),
    ...
    tagClick(index, item) {
      if (item.key) {
        ...
        if (item.time == 4) {
          ...
          this.realTimeSel.startDate = this.$u.timeFormat(
            yearOneDate,
            "yyyy-mm-dd",
          );
        }
    ...
    CrearOrder(productCode, index) {
      ...
      if (this.system) {
        this.$refs.popDatabase.src =
          "https://res-oss.elist.com.cn/wxImg/vip/ddtj.svg";
      } else {
        this.$refs.popDatabase.src =
          "https://res-oss.elist.com.cn/wxImg/vip/ddtj.png";
      }
