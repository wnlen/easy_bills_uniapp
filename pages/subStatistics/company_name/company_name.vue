    ...
    >
      ...
      >
        <view
          ...
          style="width: 95%; border-radius: 12.24rpx; background-color: #f8f8f8"
        >
          <view
            class="flex-col justify-center"
            style="width: 5%; height: 100%; height: 5vh"
          >
            <u-icon
              class="mr10"
              name="search"
        ...
        <view
          class="ml10 flex-col justify-center"
          style="width: 5%; height: 5vh"
        >
          <u-icon
            class="ml10"
            name="https://res-oss.elist.com.cn/wxImg/order/add.png"
            color="#01BB74"
            size="50"
          ></u-icon>
        </view>
