    ...
    <view class="ml20 mr48 pd30 bg-white mt10">
      ...
      >
        <text style="color: red"
          ><text class="ft-gray ml5">开票金额</text></text
        >
      ...
      >
        <text style="color: red"
          ><text class="ft-gray ml5">抬头类型</text></text
        >
        <view class="flex-row justify-end items-center flex-1">
      ...
      >
        <text style="color: red"
          >*<text class="ft-gray ml5">发票抬头</text></text
        >
        <view class="flex-row justify-end items-center flex-1">
          <input
      ...
      >
        <text style="color: red"
          ><text class="ft-gray ml5">银行账号</text></text
        >
        <view class="flex-row justify-end items-center flex-1">
          <input
            v-model="Bank"
      ...
      >
        <text style="color: red"
          ><text class="ft-gray ml5">企业地址</text></text
        >
        <view class="flex-row justify-end items-center flex-1">
          <input
            v-model="invoice.site"
            type="text"
            maxlength="20"
            class="text-right ft29"
            placeholder="选填"
      ...
      >
        <text style="color: red"
          ><text class="ft-gray ml5">企业电话</text></text
        >
        <view class="flex-row justify-end items-center flex-1">
          <input
...
export default {
  ...
  methods: {
    jump() {
      uni.navigateTo({
        url:
          "/pages/subUser/webpage?url=" +
          "https://res-oss.elist.com.cn/notice/BillingInstructions-v1.htm",
      });
    },
    installInvoice() {
