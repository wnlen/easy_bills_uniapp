<template>
  <view class="pt60">
    ...
    <view class="ml32 mr32 bg-white">
      <view
        class="flex-row pb35 u-border-bottom items-center justify-between"
      ...
      <view
        class="flex-row pt35 pb35 u-border-bottom items-center justify-between"
      >
      ...
      <view
        class="flex-row pt35 pb35 items-center justify-between u-border-bottom"
      >
        <text class="ft-gray">性别</text>
        <view class="flex-row justify-end items-center flex-1">
          <picker
            @change="bindPickerChange"
            :value="Number(vuex_user.data.gender)"
            :range="array"
          >
      ...
      <view
        class="flex-row pt35 pb35 items-center u-border-bottom justify-between"
      >
        <text class="ft-gray">状态</text>
        <view class="flex-row justify-end items-center flex-1" @click="jump">
          <u-tag
            v-if="ac ? ac.id != undefined : false"
            text="已完善"
            mode="plain"
            type="success"
          />
          <u-tag
            v-if="ac ? ac.id == undefined : true"
            text="未完善"
            mode="plain"
            type="error"
          />
    ...
    <view
      class="flex-col pl60 pr60 pb60 pt60 vw100"
