<template>
  <view class="fixed-bar-height">
    ...
    <view class="ml48 mr48 mt40 flex-col">
      <view
        class="flex-row justify-between items-center u-border-top u-border-bottom pt20 pb20"
      >
        <text class="ft29">联系号码</text>
        <view
          class="ft29 flex-row items-center"
          @click="qiyeAuth(infos.contactPhoneNumber)"
        >
      ...
      <view
        class="flex-row justify-between items-center u-border-bottom pt20 pb20"
      >
