<template>
	<view class="vh100 vw100 flex-col items-center" style="background-size: cover; background-image: url('https://res-oss.elist.com.cn/wxImg/user/unsubscribe.png')">
		<view class="absolute">
			<u-navbar :placeholder="true" :background="uNa" :border-bottom="false"></u-navbar>
		</view>
		...
		<view class="" style="margin-top: 0%; background-color: #ffffff; border-radius: 12rpx; padding: 40rpx; padding-bottom: 140rpx">
			<view class="mt45">
				...
				<view class="flex-row justify-left items-center u-border-bottom">
					...
					<u-input border="none" :value="maskPhoneNumber(vuex_user.phone)" type="text" :disabled="true" placeholder="请输入手机号"></u-input>
				</view>
			</view>
			<view class="mt30">
				<view class="">验证码</view>
