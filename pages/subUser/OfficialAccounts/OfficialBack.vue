...
<script>
	export default {
		...
		onLoad(option) {
			...
			const url =
				`https://open.weixin.qq.com/connect/oauth2/authorize?appid=${appid}&redirect_uri=${redirect_uri}&response_type=code&scope=snsapi_base&state=${this.vuex_user.phone}#wechat_redirect`;
			this.wzurl = url
		},
		methods: {
			bindload(e) {
