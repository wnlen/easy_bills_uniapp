...
export default {
  data() {
    return {
      ...
      webView: false,
      wzurl:
        "https://mp.weixin.qq.com/s?__biz=MzkxNjcyNTQwNw==&mid=2247483753&idx=1&sn=43290d7c375eb6a2372426a2f8d9cadc&chksm=c14aca99f63d438f5550abf444487fd63657e703b850b0d941e451a5ef5f5a8c5c1977295a61#rd",
    };
  },
  onLoad(option) {
    this.getGZHUrl();
