<template>
  <view
    ...
    style="
      ...
      background-image: url(&quot;https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/user/login.png&quot;);
    "
  >
    <!-- #ifdef MP-WEIXIN -->
    <view
      class="absolute"
      style="left: 48rpx; top: 120rpx; color: #333333"
      @click="experience"
      >暂不登录</view
    >
    <view class="form-wrap width60 flex-col items-center" style="top: 400rpx">
      <u-image
        class="login-logo"
        width="400rpx"
        src="https://res-oss.elist.com.cn/wxImg/user/logoLogin.svg"
        mode="widthFix"
      ></u-image>
      <view class="width100 pt100 pb60">
        ...
        <view
          class="width100 justify-center items-center flex-row pt30"
        ...
        >
          ...
          <view class="ml15">
            <text style="color: #aaaaaa; font-size: 24rpx"
              >同意并遵行易单据</text
            >
            <text
              style="color: #01bb74; font-size: 24rpx"
              @top.stop
              @click="jump(0)"
              >《用户服务协议》</text
            >
    ...
    >
      <view class="pd36 flex-col justify-center items-center">
        <text
          class="ft30 ft-bold ft-green mb10"
          style="color: #01bb74; font-size: 40rpx; font-weight: bold"
          >切换用户角色</text
        >
    ...
    <!-- #ifdef APP -->
    <view
      class="flex-col justify-center items-center pb350"
      style="width: 100%"
    >
      <view class="head">
      ...
      <view class="InputTab">
        ...
        <view class="headlineEnd mb36" v-if="err">
          <u-text class="ts" @click="ZC"
            >手机号或密码错误，请重新输入!!!</u-text
          >
        </view>
      ...
      <view class="module">
        ...
        <view
          class="mt20"
          style="color: #aaaaaa; font-size: 24rpx; text-align: center"
          >第三方登录</view
        >
        <view
          class="mt10 flex-row justify-center items-center"
...
export default {
  ...
  onLoad(option) {
    ...
    if (option && option.share_id) {
      ...
      console.log(
        "this.share_data.versionsthis.share_data.versionsthis.share_data.versions",
  ...
  methods: {
    ...
    wjPassword() {
      ...
      uni.navigateTo({
        url:
          "/pages/subUser/login/verificationCodeLogin/verificationCodeLogin?fromLogin=" +
          JSON.stringify(fromLogin),
      });
    },
    oneKeyLogin() {
      console.log("设备");
    ...
    LoginImport() {
      ...
      if (
        this.fromLogin.phoneNumber == "" &&
        this.fromLogin.phoneNumber.length < 11
      ) {
    ...
    getUserInfo(unionid, openIdApp) {
      if (this.isValid(unionid)) {
        ...
        uni.navigateTo({
          url:
            "/pages/subUser/bindingPhone/bindingPhone?data=" +
            JSON.stringify(dx),
        });
      } else {
