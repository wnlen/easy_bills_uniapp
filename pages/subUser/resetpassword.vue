<template>
  <view
    ...
    style="
      ...
      background-image: url(&quot;https://res-oss.elist.com.cn/wxImg/user/unsubscribe.png&quot;);
    "
  >
    <view class="absolute">
      <u-navbar
    ...
    >
      <view class="mt45">
        <view class="">手机号</view>
        <view
          class="flex-row justify-center items-center u-border-bottom relative"
        >
          <text type="primary" class="absolute" style="left: 0">+86</text>
          <u-input
            border="none"
            :modelValue="maskPhoneNumber(vuex_user.phone)"
            type="text"
            disabled="true"
            placeholder="请输入手机号"
          ></u-input>
      ...
      <view class="mt30">
        <view class="">验证码</view>
        <view
          class="flex-row justify-center items-center u-border-bottom relative mt30 pb20"
      ...
      <view class="flex-col justify-center items-center mt60">
        ...
        <view
          @click="comparisonCode"
          class="flex-row justify-end items-center"
          style="
            background: transparent;
            width: 100%;
            text-align: right;
        ...
        this.$api.user
          ...
          .then((res) => {
            if (res.data.code == 200) {
              ...
              uni.redirectTo({
                url:
                  "/pages/subPack/user/signee/add?item=" +
                  JSON.stringify(this.signature[0]),
              });
            } else {
