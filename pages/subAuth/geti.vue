<template>
  <view class="flex-col justify-center ml15 mr15">
    <view class="ml24 mt30 mr24">
      ...
      <view class="mt15">
        <u-image
          ...
          :src="
            formData.front ||
            'https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/geti/fromt.svg'
          "
          @click="imgUpdate(0)"
        ></u-image>
      </view>
    ...
    <view class="ml24 mt40 mr24">
      ...
      <view class="mt15">
        <u-image
          ...
          :src="
            formData.rear ||
            'https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/geti/rear.svg'
          "
          @click="imgUpdate(1)"
        ></u-image>
      </view>
    ...
    <view
      class="ml24 width100 justify-center items-center flex-row pt30 mr24"
          ...
          >
            <view class="">
              <text
                ...
                >我已阅读并同意</text
              >
              <text style="color: #01bb74; font-size: 12px"
                >《身份证认证协议》</text
              >
            </view>
          </u-radio>
    ...
    <view class="flex-row justify-center items-center mr24 mt20">
      <view
        @click="submit"
        class="text-wrapper_2 flex-col justify-center items-center"
        style="
          display: flex;
