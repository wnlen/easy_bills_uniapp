  ...
  <view class="uploadingCommodity">
    ...
    <view class="uploadingCommodityFrom">
      ...
      <view class="uploadingCommodityFromCard">
        ...
        <u-input
          :modelValue="uploadingCommodity.explainRemark"
          type="textarea"
          border="none"
          placeholder="请输入"
        />
      ...
      <view
        class="flex-row justify-end items-center pr24 pt48"
        style="width: 100%"
      >
        ...
        <u-switch
          size="35"
          active-color="#01BB74"
          v-model="uploadingCommodity.top"
        ></u-switch>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    getCommodityDetails(id) {
      ...
      this.$api.library
        ...
        .then((res) => {
          ...
          if (
            this.uploadingCommodity.img != null &&
            this.uploadingCommodity.img != undefined &&
    ...
    updMerchandiseInventory() {
      ...
      if (
        (this.imgList.uploading == undefined && this.imgList.length > 0) ||
        (this.imgList.uploading == null && this.imgList.length > 0)
      ) {
