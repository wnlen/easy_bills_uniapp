<template>
  <view>
    ...
    <view class="flex-col pt24" style="width: 100%; height: 200rpx">
      <view
        class="relative flex-row justify-center items-center pd24 mt24"
        style="width: 100%"
      >
...
export default {
  ...
  methods: {
    ...
    commodityDetailsUpdate() {
      ...
      uni.navigateTo({
        url:
          "/pages/subOrder/commodityDetails/updateCommodity?id=" +
          this.details.id,
      });
    },
  },
