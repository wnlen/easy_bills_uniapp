              ...
              >
                ...
                <view
                  ...
                  :style="{
                    ...
                    color: '#ffffff',
                    width:
                      item2.identity == '1' || item2.identity == '0'
                        ? '100rpx'
                        : '80rpx',
                  }"
                >
  ...
  onShareAppMessage(ops) {
    ...
    if (ops.from === "button") {
      ...
      return {
        title: title,
        path:
          "/pages/subMessage/friend_apply_for/shareFriend?phone=" +
          phone +
          "&invitationRole=" +
          this.vuex_userRole,
        imageUrl: imageUrl,
