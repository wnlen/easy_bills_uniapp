		...
		>
			...
			<view class="items-center" v-if="invCardEmpty && hideEmptyView">
				<view class="invCard" @click="jumpAddCommodity">
					...
					<u-icon @tab.stop class="absolute" style="bottom: 24rpx; right: 24rpx" name="plus-circle" color="#01BB74" size="50"></u-icon>
				</view>
			...
			<view class="invCard" v-for="(item, index) in orderList" :key="index">
				...
				<u-icon @tab.stop class="absolute" style="bottom: 24rpx; right: 24rpx" name="plus-circle" color="#01BB74" size="50" @click="addOrderBill(item)"></u-icon>
			</view>
				...
				<z-paging v-if="shoppingTrolley" ref="pagingCheck" :fixed="false" v-model="addList" @query="queryListCheck">
					...
					<view slot="bottom">
						<view class="bottomCard">
							...
							<u-button shape="circle" :custom-style="bottomCustomStyle" type="success" @click="closeOpen">保存</u-button>
						</view>
					</view>
				</z-paging>
			</view>
