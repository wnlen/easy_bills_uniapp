		...
		<view class="form-wrap  pt20  absolute" style="background-color:#ffffff;"
				...
				<view class="flex-col justify-left">
					...
					<view class="flex-row items-center width100 pt20 pb20 u-border-bottom">
						...
						<input placeholder-class="placeholder_class" type="text" v-model="receipts.kTakeE"
							:style="{color:ifInput(receipts.kTakeE)}" maxlength="10" placeholder="请输入收货人姓名请输入收货人姓名"
							class="u-line-1 ml15 endcolor" />
					</view>
			...
			<scroll-view enhanced :show-scrollbar="false" scroll-y="true"
				...
				<view style="width: 100%;background-color: #ffffff;" v-for="(item, index) in orderItemList" :key="index"
					class="mb12 mt12" @click="merchandiseInventory(false)">
					...
					<view class="form-bottom ft-gray">
						<view class="flex-col justify-between ft24 pt20 pb10 mr24">
							<view class="textcolor pt20 pb20 u-border-bottom">
								...
								<text :style="{color:'#333333'}" v-else class="ml15 endcolor">
									{{ vuex_user.phone }}</text>
							</view>
							<view class="textcolor pt20 pb20 u-border-bottom">
								联系人:
			...
			<view class="mt60 pl20 pr20 pb30 flex-row">
				...
				<view class="" style="width: 40%;padding: 12rpx;">
					<u-button plain hover-class="none" :custom-style="{border:'1px solid #01BB74',color:'#01BB74'}"
						@click="draftOrder" shape="circle">存草稿</u-button>
				</view>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			searchIFNumberBlur(e) {
				...
				// if (this.searchDomain.verification != undefined && this.searchDomain.verification != null && this
				// 	.searchDomain.verification != "") {
				...
				// 	if (this.searchDomain.remark != undefined && this.searchDomain.remark != null && this.searchDomain
				// 		.remark != "") {
				...
				// if (this.searchDomain.user != undefined && this.searchDomain.user != null && this.searchDomain.user !=
				// 	"") {
			...
			sendOrderImg() {
				return new Promise((resolve) => {
					...
					var bossNumber = this.vuex_work == "Y" ?
						this.vuex_user.workData.bossNumber : this.vuex_user.phone || this.vuex_user.data
						.phoneNumber
