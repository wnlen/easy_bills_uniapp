<template>
  <view
    ...
    style="background-color: #ffffff; overflow-x: hidden"
  >
    <u-navbar
      :autoBack="true"
      :placeholder="true"
    ...
    >
      <view
        class="flex-row items-center justify-center ml48"
        style="width: 100%"
      >
    ...
    <view
      class="width100"
      style="height: 80vh; text-align: center; margin-left: 10vw"
    ...
    >
      ...
      >
        <view class="relative" style="height: 100%; width: 100%">
          ...
          <view
            ...
            style="height: 40%; font-size: 36rpx; font-weight: 600"
            >请选择转发版本</view
          >
          <view
            class="u-border-top absolute al"
            style="bottom: 0; height: 30%; width: 100%"
          >
            <view
              class="u-border-right item flex-col justify-center items-center"
              style="height: 100%"
            >
              <button
                class="fx"
            ...
            <view
              class="item flex-col justify-center items-center"
              style="height: 100%"
            >
              <button
                class="fx"
      ...
      <view
        class="mt45 flex-col justify-center"
        style="
          width: 80vw;
          text-align: center;
          align-items: center;
      ...
      >
        <view class="" style="width: 60vw; height: 20vh">
          <u-image
            ...
            width="100%"
            height="100%"
            src="https://res-oss.elist.com.cn/wxImg/order/fscg.png"
          ></u-image>
        </view>
        <view
        ...
        <view
          ...
          style="color: #aaaaaa; font-size: 26rpx; font-weight: normal"
          >电子单据已发送给收货人</view
        >
        ...
        <view class="flex-col justify-left">
          ...
          <view class="flex-row items-center width100 u-border-bottom">
            ...
            <u-button
              ...
              size="mini"
              hover-class="none"
              :custom-style="{ backgroundColor: '#01BB74', color: '#ffffff' }"
              @click="jumpTable"
            >
              选择客户
            </u-button>
          ...
          >
            ...
            <input
              ...
              :style="{
                color: ifInput(receipts.creationTime) ? '#333333' : '#D8D8D8',
              }"
              type="text"
            ...
            <view class="flex-col justify-between ft24 pt20 pb10 mr24">
              ...
              <view class="textcolor pt20 pb20 u-border-bottom">
                ...
                <text :style="{ color: '#333333' }" class="ml15 endcolor">{{
                  vuex_user.data.name || vuex_user.phone || vuex_user.data.phone
                }}</text>
              </view>
              <view class="textcolor pt20 pb20 u-border-bottom">
                联系电话:
                <text
                  class="ml15 endcolor"
                  :style="{ color: '#333333' }"
                  @click="callPhone(vuex_user.phoneNumber)"
                >
...
export default {
  ...
  onShow() {
    ...
    // #endif
    if (
      uni.getStorageSync("inventoryStockpile") != undefined &&
      uni.getStorageSync("inventoryStockpile") != null &&
      uni.getStorageSync("inventoryStockpile") != ""
    ) {
  ...
  onLoad(options) {
    ...
    this.receipts.creationTime = this.$u.timeFormat(
      order.bill.creationTime,
      "yyyy-mm-dd",
    );
  ...
  methods: {
    ...
    authentication() {
      ...
      if (this.$refs.popOrder.authShow) {
        ...
        console.log("安全认证");
        if (
          this.vuex_user.workData.id != null &&
          this.vuex_user.workData.id != ""
        ) {
    ...
    InitSearch(e) {
      ...
      this.receipts.organizationE = this.receipts.organizationE.replace(
        /\s+/g,
        "",
      );
          ...
          .then((res) => {
            ...
            if (userIfOk) {
              ...
              if (cRelation != undefined && cRelation != null) {
                this.receipts.bossNumberE =
                  user.work != "0" ? cRelation.bossNumber : user.phoneNumber;
                this.receipts.staffNumberE =
                  user.work != "0" ? cRelation.staffNumber : user.phoneNumber;
                ...
                if (ifwork) {
                  ...
                  if (
                    cRelation.bossNumber == this.vuex_user.workData.bossNumber
                  ) {
    ...
    searchIFNumberBlur(e) {
      ...
      if (this.searchDomain.verification) {
        if (this.searchDomain.verification.enterpriseName) {
          this.receipts.organizationE =
            this.searchDomain.verification.enterpriseName;
        ...
        if (
          this.searchDomain.remark &&
          this.searchDomain.verification == null
        ) {
          ...
          if (this.searchDomain) {
            if (this.searchDomain.cRelation) {
              this.receipts.organizationE =
                this.searchDomain.cRelation.bossNumber;
    ...
    loadOrderNo() {
      ...
      this.receipts.jobNumberS =
        this.vuex_user.data.work != "0"
          ? this.vuex_user.workData.jobNumber
          : "";

      this.receipts.contactsS =
        this.vuex_user.data.work != "0"
          ? this.vuex_user.data.name || this.vuex_user.data.phoneNumber
          : this.vuex_user.phone;
      ...
      try {
        ...
        this.receipts.bossNumberE =
          res.data.identity == "0" ? res.data.staffNumber : res.data.bossNumber;
        this.receipts.staffNumberE = res.data.staffNumber;
        this.receipts.organizationE = res.company;
        this.receipts.takeE =
          res.data.name || res.data.staffNumber || res.data.bossNumber;
        ...
        console.log(
          "companyNameJSON===err===>",
          uni.getStorageSync("companyNameJSON"),
        );
      }
    },
    sendInit() {
      return new Promise((resolve) => {
        ...
        this.receipts.contactsS =
          this.vuex_user.data.name || this.vuex_user.phone;
    ...
    sendOrderImg() {
      return new Promise((resolve) => {
        ...
        var imgListO = this.fileList
          .filter((res) => res.id && !imgRemove.includes(res.id))
          .map((res) => res.url);
