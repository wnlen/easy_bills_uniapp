        ...
        <view class="width100" style="height: 80vh; text-align: center; margin-left: 10vw" v-show="vuex_userRole == 'D' && shareShow == true">
            ...
            <view class="mt45 flex-col justify-center" style="width: 80vw; text-align: center; align-items: center; height: 50vh">
                ...
                <view class="flex-row justify-center items-center mt40">
                    ...
                    >
                        <u-icon class="pr10" label-color="#01BB74" label="微信分享好友" labelPos="right" name="weixin-fill" color="#01BB74" size="30"></u-icon>
                    </button>
                ...
                <view class="flex-col justify-left">
                    ...
                    <view class="flex-row items-center width100 pt20 pb20 u-border-bottom">
                        ...
                        <view class="flex-row" @click="$refs.calendars.open()">
                            ...
                            <u-icon class="" size="45" name="https://res-oss.elist.com.cn/wxImg/order/time.png"></u-icon>
                        </view>
