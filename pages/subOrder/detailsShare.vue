<template>
  <view class="vh100 vw100" style="background-size: cover">
    ...
    <u-empty
      icon="https://res-oss.elist.com.cn/wxImg/order/orderEmpty.svg"
      iconSize="400rpx"
      v-if="shareShow"
      text="订单已删除~"
      mode="search"
...
export default {
  ...
  methods: {
    ...
    shareClick() {
      ...
      if (
        this.vuex_userRole != null &&
        this.vuex_userRole != undefined &&
        this.vuex_userRole != ""
      ) {
        uni.switchTab({
          ...
          if (user) {
            ...
            if (identity != "0") {
              if (bossE) {
                ...
                if (identity == "1") {
                  this.LookBtn =
                    staffE && boss != this.post.bossNumberE ? "N" : "Y";
                }
              }
