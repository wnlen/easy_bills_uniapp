<template>
	<view class="vh100 vw100" style="background-size: cover;">
		...
		<u-empty src="https://res-oss.elist.com.cn/wxImg/order/orderEmpty.svg" icon-size="400" v-if="shareShow"
			text="订单已删除~" mode="search" margin-top="300"></u-empty>
			...
			<view class="ml20 mr20">
				...
				<view class="flex-row" style="margin-top: 2%;">
					...
					<view class="flex-row justify-center items-center" style="width: 60%;">
						<u-image :show-menu-by-longpress="false" src="@/static/img/order/dd2x.svg" width="146px"
							height="22px"></u-image>
					</view>
					<view class="" style="width: 20%;">
				...
				<view class="bg-white pb350 flex-co mt10">
					<view v-if="wxType==1&&LookShar=='D'" class="absolute" style="right: 10px;">
						<u-image v-if="post.paymentState=='0'" :show-menu-by-longpress="false"
							src="https://res-oss.elist.com.cn/wxImg/order/dqs.png" width="120px"
							height="120px"></u-image>
						<u-image v-if="post.paymentState=='1'" :show-menu-by-longpress="false"
							src="https://res-oss.elist.com.cn/wxImg/order/yqs.png" width="120px"
							height="120px"></u-image>
						<u-image v-if="post.paymentState=='2'" :show-menu-by-longpress="false"
					...
					<view class="flex-row justify-center items-end mt5" @click="exit"
				...
				<view class="fixed-bar" style="background: none;">
					<view class="pl30 pr30 pb30 flex-row justify-between items-center">
						<view v-if="LookBtn=='Y'&&post.paymentState=='0'&&post.lockOrder!=1"
							class="flex-row flex-1 items-center">
							<u-button hover-class="none" :custom-style="{backgroundColor:'#01BB74'}" class="width100"
								type="primary" shape="circle" @click="onConfirm">确认签收</u-button>
						</view>
					</view>
				</view>
			</view>
		...
		methods: {
			getQs() {
				...
				this.$u.post('/edo/ac/get', {
					"user": this.vuex_user.data.work == "0" ? this.vuex_user.phone : this.vuex_user.workData
						.bossNumber
				}).then(res => {
