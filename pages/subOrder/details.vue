    ...
    >
                ...
                <view class="bg-white pb350 flex-co mt10">
                    ...
                    <view class="flex-row justify-left items-center mt12">
                        <view
                            ...
                            v-if="wxType != 1"
                            :style="{
                                width: vuex_userRole != 'R' ? ((vuex_user.data.work == '1' ? vuex_user.workData.identity != '3' : true) ? '48%' : '74%') : '74%'
                            }"
                    ...
                    <view v-if="wxType == 1" class="flex-row justify-center items-end mt5" @click="exit" style="width: 100%; color: #aaaaaa">关闭单据 ></view>
                </view>
        ...
        <view class="height80" style="width: 100%; text-align: center" v-if="show == 0">
            <view class="width100" style="padding-top: 30%" v-if="text2">
                <view class="width100" style="font-weight: bold; font-size: 48rpx; text-align: center">验证用户</view>
            ...
            <view class="width100 flex-col justify-center items-center" style="padding-top: 40%" v-if="text">
                <u-image class="login-logo" width="400rpx" src="https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/user/logo.svg" mode="widthFix"></u-image>
        ...
        loadData() {
            ...
            this.$api.order
                ...
                .then((res) => {
                    ...
                    console.log('this.post.bossNumberS == this.vuex_user.phone', this.post.bossNumberS == this.vuex_user.phone);
                    console.log('this.post.staffNumberS == this.vuex_user.phone', this.post.staffNumberS == this.vuex_user.phone);
                    if (this.post.bossNumberS == this.vuex_user.phone || this.post.staffNumberS == this.vuex_user.phone) {
                        // this.LookShar = "N"
                    }
                })
                .catch((res) => {});
