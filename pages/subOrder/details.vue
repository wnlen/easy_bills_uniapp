<template>
  <view
    ...
    :style="{
      backgroundImage:
        show == 0
          ? 'url(https://ydj-lsy.oss-cn-shanghai.aliyuncs.com/applet-img/img/obj/bg.png)'
          : '',
    }"
  ...
  >
    ...
    <view v-if="show == 1" class="height80 fixed-bar-height">
      <view class="ml20 mr20">
        ...
        <view class="bg-white pb350 flex-co mt10">
          <view
            v-if="wxType == 0 || wxType == undefined"
            class="absolute"
            style="right: 20rpx"
          >
            <u-image
          ...
          >
            ...
            ></u-image>
            <u-image
              v-if="post.paymentState == '0' && port == 'R'"
              :show-menu-by-longpress="false"
              src="https://res-oss.elist.com.cn/wxImg/order/dqs-r.png"
              width="240rpx"
              height="240rpx"
            ></u-image>
            <u-image
              v-if="post.paymentState == '1' && port == 'D'"
              :show-menu-by-longpress="false"
              src="https://res-oss.elist.com.cn/wxImg/order/yqs.png"
              width="240rpx"
              height="240rpx"
            ></u-image>
            <u-image
              v-if="post.paymentState == '1' && port == 'R'"
              :show-menu-by-longpress="false"
              src="https://res-oss.elist.com.cn/wxImg/order/yqs.png"
              width="240rpx"
              height="240rpx"
            ></u-image>
            <u-image
              v-if="post.paymentState == '2' && port == 'D'"
              :show-menu-by-longpress="false"
              src="https://res-oss.elist.com.cn/wxImg/order/ysk.png"
              width="240rpx"
              height="240rpx"
            ></u-image>
            <u-image
              v-if="post.paymentState == '2' && port == 'R'"
              :show-menu-by-longpress="false"
              src="https://res-oss.elist.com.cn/wxImg/order/yfk.png"
              width="240rpx"
              height="240rpx"
          ...
          <view
            class="pd20 black-border-top black-border-left black-border-right"
          >
            <view class="flex-row" style="font-family: ddbh">
              <u-icon
                size="50"
                name="https://res-oss.elist.com.cn/wxImg/order/number.svg"
              ></u-icon>
              <text
                class="ml10 mt10"
                style="color: #fa5151; font-size: 30rpx"
                >{{ post.orderNumber || "" }}</text
              >
            </view>
            <view class="flex-row mt13 xqcss">
              <view class="">发货日期：</view>
              <view class="yrd mt5">{{
                $u.timeFormat(post.creationTime, "yyyy-mm-dd") || ""
              }}</view>
            </view>
            <view class="flex-row mt13 xqcss">
          ...
          <view class="form-middle" style="overflow-x: auto">
              ...
              <view class="table">
                ...
                >
                  <view class="table-cell flex-col justify-center items-center">
                    <text class="ft24 line25 text-center">{{
                      item.description
                    }}</text>
                  </view>
                  <view class="table-cell flex-col justify-center items-center">
                  ...
                  <view class="table-cell flex-col justify-center items-center">
                    <text class="ft24">{{
                      towDig(item.quantity, item.unitPrice)
                    }}</text>
                  </view>
                </view>
              </view>
            ...
            <view
              class="xqcss pd10 pt10 pb10 black-border-left black-border-right"
            >
              <text class="ml10 xqcss">合计：</text>
              <text class="xqcss"
                >¥
                {{
                  versions == "Y" ? DigPrice(post.price) || "" : "****"
                }}</text
              >
            </view>
            <view
            ...
            >
              ...
              <text class="yrd">{{
                versions == "Y" ? digitUppercase(post.price) : "****"
              }}</text>
            </view>
            ...
            <view
              class="xqcss pt35 flex-row items-center black-border-left black-border-right"
              style="height: 12vh"
            ...
            <view
              class="xqcss flex-row items-center black-border-left black-border-right pt20 xqcss"
            ...
            <view
              class="xqcss flex-row items-center black-border-left black-border-right xqcss"
            >
            ...
            >
              <view
                class="flex-row ml20 mt14"
                @click="callPhone(post.staffNumberS)"
              >
                <text>联系电话：</text>
          ...
          <view class="flex-row justify-left items-center mt12">
            ...
            >
              <view
                class="flex-row justify-between ml10 mb4"
                style="border-bottom: 2rpx solid #01bb74; left: 20rpx"
                @click="print"
              >
                <u-icon
                  name="https://res-oss.elist.com.cn/wxImg/print/print.svg"
                  label-color="#01BB74"
                  label="打印单据"
                  size="40"
                ></u-icon>
            ...
            >
              <view
                style="
                  border-bottom: 2rpx solid #ffc300;
                  padding-bottom: 1rpx;
                  padding-top: 3rpx;
                  font-weight: 500;
                "
            ...
            >
              <view
                style="
                  border-bottom: 2rpx solid #4d91ff;
                  padding-bottom: 1rpx;
                  padding-top: 3rpx;
                  font-weight: 500;
                "
          ...
          <view
            v-if="wxType == 1"
            class="flex-row justify-center items-end mt5"
            @click="exit"
        ...
        <view class="fixed-bar" style="background: none">
          <view class="pl30 pr30 pb30 flex-row justify-between items-center">
            <view
              v-if="vuex_user.workData.identity != '3' && post.lockOrder != 1"
    ...
    >
      <view class="width100" style="padding-top: 30%" v-if="text2">
        <view
          class="width100"
          style="font-weight: bold; font-size: 48rpx; text-align: center"
          >验证用户</view
        >
        <view
          class="width100 mb54"
        ...
        <view
          class="mt36 flex-row justify-center items-center"
          style="color: #aaaaaa; width: 100%"
          @click="exit"
        >
          关闭单据
      ...
      <view
        class="width100 flex-col justify-center items-center"
    ...
    >
      ...
      >
        <view class="absolute pt20" style="width: 100%; top: 0; height: 75%">
          ...
          >
          <view
            class="flex-col items-center justify-center mt20"
          ...
          <view
            @click="goPath('/pages/subUser/resetpassword')"
            class="ft12 pr30 flex-row justify-end pt15"
            style="color: #999; width: 100%"
            >找回密码</view
          >
        </view>
        <view
          class="flex-row items-center absolute u-border-top"
    ...
    <u-popup
      v-model="showBrowsePrint"
      :custom-style="customStylePrint"
      mode="center"
      border-radius="14"
      width="650rpx"
      :height="showBrowsePrintHeight"
    >
      <view
        class="w100 pt30 relative flex-col items-center"
        style="
          height: 100%;
          box-shadow: 2rpx 2rpx 2rpx 2rpx rgba(153, 153, 153, 0.05);
        "
      >
        <scroll-view
          scroll-y="true"
          class="u-border pt20 pb20"
...
export default {
  ...
  methods: {
                  ...
                  .then((res) => {
                    ...
                    if (res.data.data.map) {
                      if (res.data.data.map.boss == this.post.bossNumberE) {
                        ...
                        if (
                          res.data.data.phoneNumber == this.post.bossNumberE
                        ) {
                          this.LookShar = "F";
                        } else {
                          this.LookShar = "F";
    ...
    loadData() {
      ...
      this.$api.order
        ...
        .then((res) => {
          ...
          console.log(
            "this.post.bossNumberS == this.vuex_user.phone",
            this.post.bossNumberS == this.vuex_user.phone,
          );
          console.log(
            "this.post.staffNumberS == this.vuex_user.phone",
            this.post.staffNumberS == this.vuex_user.phone,
          );
          if (
            this.post.bossNumberS == this.vuex_user.phone ||
    ...
    onConfirm() {
      ...
      var that = this;
      if (
        that.qsrList.length == 0 ||
        (that.qyList == null && this.vuex_user.data.work == "0")
      ) {
        //  无签收人
