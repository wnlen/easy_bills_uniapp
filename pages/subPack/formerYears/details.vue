			...
			<view class="ml20 mr20">
				...
				<view class="flex-row" style="margin-top: 2%;">
					<view class="" style="width: 20%;">
						...
						<u-image mode="scaleToFill" src="https://res-oss.elist.com.cn/wxImg/order/logo.svg"
							width="100px" height="40px"></u-image>
					</view>
				...
				<view class="bg-white pb350 flex-co mt10">
					<view v-if="wxType==0||wxType==undefined" class="absolute" style="right: 10px;">
						<u-image v-if="post.paymentState=='0'&&vuex_userRole!='R'"
						...
						<u-image v-if="post.paymentState=='0'&&vuex_userRole=='R'"
							...
							height="120px"></u-image>
						<u-image v-if="post.paymentState=='1'" src="https://res-oss.elist.com.cn/wxImg/order/yqs.png"
							width="120px" height="120px"></u-image>
						<u-image v-if="post.paymentState=='2'&&vuex_userRole!='R'"
					...
					<view v-if="wxType==1&&LookShar=='S'" class="absolute" style="right: 10px;">
						<u-image v-if="post.paymentState=='0'" src="https://res-oss.elist.com.cn/wxImg/order/dqs.png"
							width="120px" height="120px"></u-image>
						<u-image v-if="post.paymentState=='1'" src="https://res-oss.elist.com.cn/wxImg/order/yqs.png"
							width="120px" height="120px"></u-image>
						<u-image v-if="post.paymentState=='2'" src="https://res-oss.elist.com.cn/wxImg/order/yfk.png"
							width="120px" height="120px"></u-image>
					</view>

					<view v-if="wxType==1&&LookShar=='F'" class="absolute" style="right: 10px;">
						<u-image v-if="post.paymentState=='0'" src="https://res-oss.elist.com.cn/wxImg/order/dqs-r.png"
							width="120px" height="120px"></u-image>
						<u-image v-if="post.paymentState=='1'" src="https://res-oss.elist.com.cn/wxImg/order/yqs.png"
							width="120px" height="120px"></u-image>
						<u-image v-if="post.paymentState=='2'&&port=='R'"
					...
					<view class="flex-row justify-left items-center mt12">
						...
						<view class="flex-row justify-center items-center mt15" @click="DownPdf(post)"
							...
							<view style="border-bottom: 1px solid #FFC300;padding-bottom: 1rpx;padding-top: 3rpx;font-weight: 500;">下载PDF
							</view>
						</view>
					</view>
				</view>
				<view class="recently-cat flex-row flex-wrap mt10">
					<text v-for="(item,index) in recentlyData" @click="recentlyClick(item)"
						:key="index">{{item.productName}}</text>
				</view>
			</view>
		</view>
