<template>
  <view
    class="relative flex-col items-center"
  ...
  >
    ...
    <view class="flex-col justify-center items-center mt30">
      <view class="">
        <u-icon
          name="https://res-oss.elist.com.cn/wxImg/user/del.svg"
          size="200"
        ></u-icon>
      </view>
      <view
    ...
    >
      <view class="flex-col items-baseline pt25 pb30">
        <view class="flex-row items-center">
          <u-icon
            name="https://res-oss.elist.com.cn/wxImg/user/dian.svg"
            size="15"
          ></u-icon>
          <view class="title ml15 pb15 mt10">订单信息确认</view>
        </view>
        <view class="text"
          >您在发货端和收货端内的所有订单将会被清空，请确保您已处理完收发端的所有单据。</view
        >
      </view>
      <view class="flex-col items-baseline pb30">
        ...
        <view class="text"
          >个人信息、公司信息、签收人信息、好友信息等将会被清空。</view
        >
      </view>
      <view class="flex-col items-baseline pb30">
        <view class="flex-row items-center">
        ...
        <view class="text"
          >您平台的虚拟权益如您在【我的订购】中已购买的全部内容，将视为您自动放弃无法恢复。</view
        >
      </view>
    </view>
    ...
    >
      <view
        class="flex-row justify-center items-center mr24 ml24 mb20"
          ...
          >
            <view class="">
              <text
                @tap.stop
                @click="radioGroupChange"
                style="color: #aaaaaa; font-size: 24rpx"
                >同意并遵行易单据</text
              >
              <text
                @tap.stop
...
export default {
  data() {
    return {
      disabled: true,
      wordUrl:
        "https://docs.google.com/gview?url='https://res-oss.elist.com.cn/excel/ydj.docx'",
      showAddPhone: false,
      addPhone: "",
    };
  },
  methods: {
    ...
    confirm() {
      ...
      console.log(
        mobileRegex.test(this.addPhone),
        fixedLineRegex.test(this.addPhone),
        phoneRegex.test(this.addPhone),
      );
    ...
    jumpWord() {
      ...
      uni.navigateTo({
        url:
          "/pages/subPack/user/affirm/word?url=" +
