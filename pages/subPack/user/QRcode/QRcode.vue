<template>
  <view class="root">
    ...
    <view class="card">
      <view class="cardCode">
        <view
          class="icon flex-col justify-center items-center absolute"
          style="position: relative; top: -80rpx"
        >
          <u-avatar
            :src="vuex_user.data.headPortrait"
            size="150rpx"
            mode="circle"
          ></u-avatar>
        </view>
        <view
          class="absolute"
          style="position: relative; width: 100%; top: -100rpx"
        >
          <view
    ...
    <up-overlay :show="showSF" @click="showSF = false">
      ...
      >
        <view
          class="absolute mt60"
          style="font-size: 36rpx; top: 0; height: 60rpx"
          >添加好友</view
        >
        <view
          class="flex-row text-center justify-center items-center absolute"
        ...
        <view
          v-if="!showChecked"
          class="u-border-top flex-row absolute"
          style="width: 100%; height: 104rpx; bottom: 0"
          @tap.stop
        >
          <view
            @click="
        ...
        <view
          v-if="showChecked"
          class="u-border-top flex-col absolute mt20"
          style="width: 100%; height: 200rpx; bottom: 0"
          @tap.stop
        >
          <view
            @click="
