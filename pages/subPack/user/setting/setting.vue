<template>
  <view
    class="card flex-row bg-white mt25 ml30 mr30"
    style="border-radius: 12px; width: 92vw; height: auto"
  >
  ...
  data() {
    return {
      ...
      menus: [
        ...
        {
          name: "系统设置",
          icon: "/static/img/user/setting.svg",
          url: "/pages/user/setting/setting",
        },
        {
          name: "打印机配置",
          icon: "/static/img/user/dyj.svg",
          url: "",
        },
        {
          name: "账号管理",
          icon: "/static/img/user/suo.svg",
          url: "",
        },
      ],
    };
