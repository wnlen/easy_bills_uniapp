<template>
	<view class="content items-center pt20">
		...
		<view class="ml24 mr24">
			...
			<view class="pt30">
				<SortByDrag :data="listO" :drag="drag" :minus="compile" minusName="plus-circle-fill"
					minusColor="#01BB74" height="500rpx" :itemWidth="136" :itemHeight="162" @sort="handleSort">
					<template v-slot="{item, index}">
						<view class="ml5 mr5 flex-col justify-center items-center relative"
							style="background-color: transparent;">
							<u-icon :label="item.name" size="100rpx" :name="item.icon" labelPos="bottom" label-size="25rpx"
								label-color="#333333" @touchstart="handleTouchStart" @touchend="handleTouchEnd"
