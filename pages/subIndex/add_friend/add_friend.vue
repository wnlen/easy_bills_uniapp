    ...
    <up-overlay :show="showSF" @click="showSF = false">
      ...
      >
        <view
          ...
          style="font-size: 16px; height: 5vh"
          >添加好友</view
        >
    ...
    >
      <view class="flex-col justify-center items-center" style="width: 13vw">
        <u-image
          ...
          height="50px"
          shape="circle"
          :src="item.headPortrait || defaultImg"
        ></u-image>
      </view>
      <view
        class="ml10 flex-col justify-center items-baseline"
      ...
      <view class="mr48" style="float: right; width: 10vw">
        ...
        <view
          v-if="showYQZ"
          style="width: 100px; font-size: 13px; color: #01bb74"
          class="flex-row"
          >申请中</view
        >
      </view>
  ...
  methods: {
    ...
    SearchFriend() {
      ...
      if (this.searchNumber.length == 11) {
        this.$api.user
          .searchUser({ phone: this.searchNumber, state: 1 })
          .then((res) => {
