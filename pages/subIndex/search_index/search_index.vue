	...
	<view>
		...
		<view class="header">
			<view class="header-left ml20 flex-row" style="width: 100vw;">
				...
				<u-search search-icon-color="#dcdcdc" :show-action="false" placeholder="请输入货品名称/关键字搜索" :animation="true"
					maxlength="30" shape="round" class="u-search ml15" height="60" bg-color="#F4F4F4"
					style="width: 65vw;"></u-search>
			</view>
		</view>
		...
		<view class="vw100 flex-row items-center mt30">
			...
			<view class="mt20 ml24 flex-row justify-between"
				style="font-size: 16px;font-weight: bold;display: flex;align-items: center;width: 90vw;">
		...
		<view class="ml24 mr24 vw100 mt30 flex-row"  v-if="isLook">
			<view class="pd10 ml15"
				style="border-radius: 16px;background-color: #F4F4F4;width: 100px;text-align: center;align-items: center;">
				上海机械厂
			</view>
		...
		<view class="mt20 ml24 flex-row justify-between mt40"
			style="font-size: 16px;font-weight: bold;display: flex;align-items: center;width: 90vw;">
			<view class="flex-row justify-start" style="font-size: 14px;font-weight: normal;">
				推荐搜索
			</view>
		...
		<view class="ml24 mr24 mt30 flex-row"  v-if="isLook" style="width: 100vw;">
			<view class="pd10 ml15"
				style="border-radius: 16px;background-color: #F4F4F4;width: 100px;text-align: center;align-items: center;">
				上海机械厂
			</view>
