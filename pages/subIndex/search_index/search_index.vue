<template>
  <view>
    ...
    <view class="vw100 flex-row items-center mt30">
      ...
      <view
        class="mt20 ml24 flex-row justify-between"
        style="
          font-size: 16px;
          font-weight: bold;
          display: flex;
      ...
      >
        ...
        >
          历史搜索
          <view
            class="flex-col justify-start ml10"
            style="font-size: 14px; font-weight: normal"
            @click="isLook = !isLook"
          >
            <u-icon v-if="isLook" name="eye-fill" size="35"></u-icon>
        ...
        >
          <view
            ...
            style="font-size: 14px; font-weight: normal; float: right"
          >
    ...
    <view
      class="mt20 ml24 flex-row justify-between mt40"
      style="
        font-size: 16px;
        font-weight: bold;
        display: flex;
