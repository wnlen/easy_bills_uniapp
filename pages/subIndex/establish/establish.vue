<template>
  <view>
    ...
    <view
      class="flex-row justify-center items-center ml24 mr24 mt24 pl20 pr20 pt24 pb24"
    ...
    <view
      class="mt60 pl20 pr20 pb30 absolute"
      style="bottom: 24rpx; width: 100%"
      v-if="user.port == 'D'"
    >
      <u-button
        type="primary"
...
export default {
  ...
  methods: {
    ...
    verification() {
      console.log(
        "eBossNumber-searchPhone====>",
        this.submitUser.eBossNumber == this.submitUser.searchPhone,
      );
      ...
      console.log(
        "remarkD===>",
        this.user.port == "D"
          ? this.submitUser.remarkD
          : this.submitUser.remarkR,
      );
