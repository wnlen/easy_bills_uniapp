<template>
  <view class="bg-gray vh100 vw100" style="background-color: #f4f4f4">
    <scroll-view scroll-y="true" :scroll-top="scrollTop" style="height: 85vh">
      ...
      >
        <view class="" v-if="item.formUserId != vuex_user.phone">
          ...
          <view
            class="mt30"
            style="font-size: 24rpx; height: 100%; margin-left: 12vw"
          >
            <view class="">
              <text>{{ item.name }}</text>
        ...
        <view class="mt45 mr30" v-if="item.formUserId == vuex_user.phone">
          ...
          <view
            class=""
            style="font-size: 24rpx; height: 100%; margin-right: 12vw"
          ></view>
          <view
    ...
    <view
      class="inpMess bg-white vw100 pt25"
      style="height: 14vh; background-color: #ffffff"
    >
      <view
        class="flex-row ml20 bg-white"
      ...
      <view class="flex-row mt10 mb20 ml20" style="height: 60%">
        ...
        <view class="mt10 ml10" style="height: 100%; align-items: center">
          <u-icon
            :style="{ display: showFile == 0 ? 'block' : 'none' }"
            class="mr10 ml10"
            name="plus-circle"
            size="50"
            @click="sendImg"
          ...
          <button
            @click="send"
            :style="{ display: showFile == 1 ? 'block' : 'none' }"
            class="fsbtm"
          >
            发送
          </button>
