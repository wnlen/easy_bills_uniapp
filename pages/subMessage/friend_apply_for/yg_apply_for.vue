<template>
  <view>
    <view
      class="ml24 mr24"
      style="height: 10vh; width: 93vw; border-radius: 6px; align-items: center"
      v-show="SHOW == 1"
    >
      <u-swipe-action
        :btn-width="180"
      ...
      >
        <view
          style="width: 96vw; height: 80px"
          class="flex-row items-center u-border-bottom mt20 pd15"
        >
          <u-image
            :src="item2.img || defaultImg"
            shape="circle"
            width="50px"
            height="50px"
          ></u-image>
          <view
            class="flex-col justify-center ml26"
            style="height: 100%; width: 40%"
          >
            <text class="title mb8" style="font-size: 32rpx">{{
              item2.aName || item2.aUser
            }}</text>
            <view
              class="title"
              style="font-size: 27rpx; color: #999999; letter-spacing: 1rpx"
            >
              邀请您成为{{
                item2.ifType == "0"
                  ? "主账号"
          ...
          <view
            class="flex-col justify-evenly items-end"
          ...
          >
            <view class="flex-col relative items-end" style="height: 100%">
              <view class="mt20" style="color: #d8d8d8; font-size: 12px">
                <text>{{
                  $u.timeFormat(item2.createTime, "yyyy-mm-dd hh:MM:ss")
                }}</text>
              </view>
              <view
                class="absolute flex-row justify-center items-center"
                style="bottom: 8px; right: 0"
              >
