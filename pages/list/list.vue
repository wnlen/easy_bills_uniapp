...
<template>
	<view class="root">
		<z-paging ref="paging" use-virtual-list :force-close-inner-list="true"
			...
			<view slot="top">
				...
				<!-- 		<u-navbar :is-back="false" :border-bottom="false" :titleBold="true" title-color="#000000"
					...
					<view class="flex-row items-center justify-left ml48" style="width: 400px;">
						<view class="flex-row justify-center items-center" style="background-color: #ffc300;height: 22px;width:70px;border-radius: 8rpx;color: #ffffff;font-size: 11px;font-weight: 900;
						box-shadow: 1.7px 1.5px 1px 0px rgba(246, 188, 0, 0.5);">
				...
				<u-tabs :active-item-style="{paddingBottom: '20px'}" :bar-height="7" :bar-style="{marginBottom:'4px'}"
			...
			<view class="Card cardShow">
				...
				<view class="InputCard">
					...
					<view class="InputOne">
						...
						<!-- <view style="width: 12px;height: 16px;border-right: 1px solid #666666;"></view> -->
				...
				<view class="OrderCardHand" @tap.stop>
					...
					<view class="ml20" style="width: 30%;">
						<u-image :show-menu-by-longpress="false" v-if="vuex_userRole=='D'"
							...
							height="25px" :src="bat64.dqs"></u-image>
						<u-image :show-menu-by-longpress="false" v-if="vuex_userRole=='R'"
							:style="{display:item.paymentState == '0'?'inline':'none'}" class="u-img" width="60px"
							height="25px" :src="bat64.dqss"></u-image>
						<u-image :show-menu-by-longpress="false" v-if="vuex_userRole=='R'"
							:style="{display:item.paymentState == '2'?'inline':'none'}" class="u-img" width="60px"
							height="25px" :src="bat64.yfk"></u-image>
						<u-image :show-menu-by-longpress="false"
							:style="{display:item.paymentState == '1'?'inline':'none'}" width="60px" height="25px"
						...
						<view class="flex-row justify-center items-center" style="width: 100%;">
							<view class="flex-row justify-center items-center" style="width: 40%; color: #cccccc;">
								<button class="hl-btn NY flex-row items-center justify-center" type="default"
									...
									:data-id="item.id">
									<u-icon top="1px" name="zhuanfa" size="25" color="#666666" label-color="#333333"
										label-size="22"
					...
					<view v-if="!item.share" class="flex-row items-center justify-center">
						<view class="flex-row items-center justify-center">
							<button class="hl-btn flex-row items-center justify-center" @click="shareNY(item, 1)"
								...
								<u-icon top="1px" v-show="!OperatingSystem" name="zhuanfa" size="25"
									v-if="vuex_userRole === 'D' || vuex_userRole === 'R'" color="#666666"
									label-color="#333333" label-size="22"
									:label="vuex_user.data.work !== '1' && vuex_user.workDate == null ? '转发' : '转发'">
								</u-icon>
							...
							<button
								...
								<u-icon top="1px" name="order" v-if="!OperatingSystem" size="25" color="#666666"
							...
							<button
								...
								<u-icon top="1px" v-if="!OperatingSystem" name="rmb-circle" size="30" color="#666666"
									label-size="22" label-color="#333333" :label="labText"></u-icon>
							...
							<button
								...
								<u-icon v-if="!OperatingSystem" top="1px" name="trash" size="25" color="#666666"
							...
							<button
								...
								<u-icon v-if="!OperatingSystem" top="1px" name="edit-pen" size="25" color="#666666"
		...
		<u-mask :show="showMask" @click="showMask = false;password=''">
			<u-popup negative-top="100px" class="flex-col justify-center items-center" border-radius="15" mode="center"
