...
export abstract class HttpRequestAbstract {
  ...
  get<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  delete<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  head<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  options<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  post<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  put<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;
  ...
  setConfig<D = HttpTask>(
    onSend: (config: HttpRequestConfig<D>) => HttpRequestConfig<D>,
  ): void;

  connect<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  trace<T = any, R = HttpResponse<T>, D = HttpRequestTask>(
    url: string,
    data?: HttpData,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  upload<T = any, R = HttpUploadResponse<T>, D = HttpUploadTask>(
    url: string,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  download<T = any, R = HttpDownloadResponse<T>, D = HttpDownloadTask>(
    url: string,
    config?: HttpRequestConfig<D>,
  ): Promise<R>;

  middleware<T = any, R = HttpResponse<T>, D = HttpTask>(
    config: HttpRequestConfig<D>,
  ): Promise<R>;
}
